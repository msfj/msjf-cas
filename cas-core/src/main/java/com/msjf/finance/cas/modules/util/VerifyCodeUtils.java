...
public class VerifyCodeUtils {
    ...
    public static final String VERIFY_CODES = "23458ABCDEFGHJKMNPQRSTUVWXYZ";
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException{
        ...
        //Arial Bold
        Font font = new Font("Arial Bold", Font.ITALIC, fontSize);
        //    Font font = getFont();
        ...
        for(int i = 0; i < verifySize; i++){
            ...
            //affine.scale(0.1*rand.nextDouble(), 0.1*rand.nextDouble());
