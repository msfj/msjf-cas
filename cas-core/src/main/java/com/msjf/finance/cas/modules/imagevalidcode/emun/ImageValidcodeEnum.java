package com.msjf.finance.cas.modules.imagevalidcode.emun;

import com.msjf.finance.msjf.core.emun.ResponseService;

/**
 * Created by csw on 2019/1/15.
 */
public enum ImageValidcodeEnum implements ResponseService {
    ...
    ImageValidcodeEnum(String errorCode, String errorDesc) {
